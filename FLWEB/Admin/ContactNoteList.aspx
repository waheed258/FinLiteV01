<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ContactNoteList.aspx.cs" Inherits="Admin_ContactNoteList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Contact Notes</h2>
        </header>
        <div class="panel-body">
            ...
            <div class="form-group">
               ...
               &nbsp;
                ...
                <asp:GridView ID="gvConNoteList" runat="server" AllowPaging="true" EmptyDataText="No Data Found" PageSize="10"
                                ...
                                <table>
                                    ...
                                    <td>
                                        <asp:ImageButton ID="imgEdit" ToolTip="Edit" runat="server" ImageUrl="../images/icon-edit.png" Height="20" Width="20"
                                            CommandName="Edit Note" CommandArgument='<%#Eval("NotePadId") %>' />
                                        <asp:ImageButton ID="imgDelete" ToolTip="Delete" runat="server" ImageUrl="../images/icon-delete.png" Height="20" Width="20"
                                            CommandName="Delete Note" CommandArgument='<%#Eval("NotePadId") %>' OnClientClick="javascript:return confirm('Are You Sure To Delete ContactNote Details')" />
