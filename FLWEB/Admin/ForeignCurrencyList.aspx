<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ForeignCurrencyList.aspx.cs" Inherits="Admin_ForeignCurrencyList" %>
            ...
            <ContentTemplate>
                ...
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <h2 class="panel-title">Foreign Currencies</h2>
                    </header>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:ImageButton ID="imgEdit" ToolTip="Edit" runat="server" ImageUrl="~/images/icon-edit.png" Height="20" Width="20"
                                                        CommandName="Edit Currency Details" CommandArgument='<%#Eval("Id") %>' />
