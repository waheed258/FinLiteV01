<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="BookingSourceList.aspx.cs" Inherits="Admin_BookingSourceList" %>
            ...
            <ContentTemplate>
                ...
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <h2 class="panel-title">Booking Sources</h2>
                    </header>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:ImageButton ID="imgEdit" ToolTip="Edit" runat="server" ImageUrl="~/images/icon-edit.png" Height="20" Width="20"
                                                        CommandName="Edit Booking Details" CommandArgument='<%#Eval("BookingId") %>' />
                                                    <asp:ImageButton ID="imgDelete" ToolTip="Delete" runat="server" ImageUrl="~/images/icon-delete.png" Height="20" Width="20"
                                                        CommandName="Delete Booking Details" CommandArgument='<%#Eval("BookingId") %>' OnClientClick="javascript:return confirm('Are You Sure You Want To Delete Source Details')" />
                                                </td>
                                            </tr>
                                        </table>
