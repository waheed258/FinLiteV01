<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="AirSupplierList.aspx.cs" Inherits="Admin_AirSupplierList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title" runat="server">Air Suppliers</h2>
        </header>
        <div class="panel-body" >
            ...
            <div class="form-group">
               ...
               &nbsp;
                ...
                <asp:GridView ID="gvAirSupplierList" runat="server" AllowPaging="true" EmptyDataText="No Data Found" PageSize="10"
                    AutoGenerateColumns="False" CssClass="table table-bordered table-striped mb-none dataTable no-footer"
                    Width="100%" OnRowCommand="gvAirSupplierList_RowCommand" OnPageIndexChanging="gvAirSupplierList_PageIndexChanging" OnSorting="gvAirSupplierList_Sorting">
                                ...
                                <table>
                                    ...
                                    <td>
                                        <asp:ImageButton ID="imgEdit" ToolTip="Edit" runat="server" ImageUrl="../images/icon-edit.png" Height="20" Width="20"
                                            CommandName="Edit Supplier" CommandArgument='<%#Eval("SupplierId") %>' />
                                        <asp:ImageButton ID="imgDelete" ToolTip="Delete" runat="server" ImageUrl="../images/icon-delete.png" Height="20" Width="20"
                                            CommandName="Delete Supplier" CommandArgument='<%#Eval("SupplierId") %>' OnClientClick="javascript:return confirm('Are You Sure To Delete AirSupplier Details')" />
