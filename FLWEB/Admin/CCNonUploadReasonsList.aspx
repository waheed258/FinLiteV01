<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="CCNonUploadReasonsList.aspx.cs" Inherits="Admin_CCNonUploadReasonsList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <section class="panel">
        <header class="panel-heading">
         ...
         <h2 class="panel-title">NonUpload Reasons</h2>
        </header>
       ...
       <asp:Button ID="btnAdd" runat="server" Text="Add" class="btn btn-primary" OnClick="btnAdd_Click"/>
            ...
            <asp:GridView ID="gvNonUploadList" runat="server" AllowPaging="true" Width="100%" PageSize="10"
                AutoGenerateColumns="False" DataKeyNames="" CssClass="table table-striped table-bordered"
                OnRowCommand="gvNonUploadList_RowCommand" OnPageIndexChanging="gvNonUploadList_PageIndexChanging" OnSorting="gvNonUploadList_Sorting" ShowHeaderWhenEmpty="true">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:ImageButton ID="imgEdit" ToolTip="Edit" runat="server" ImageUrl="../images/icon-edit.png" Height="20" Width="20"
                                            CommandName="Edit NonUpload Details" CommandArgument='<%#Eval("NonUploadId") %>' />
                                        <asp:ImageButton ID="imgDelete" ToolTip="Delete" runat="server" ImageUrl="../images/icon-delete.png" Height="20" Width="20"
                                            CommandName="Delete NonUpload Details" CommandArgument='<%#Eval("NonUploadId") %>' OnClientClick="javascript:return confirm('Are You Sure To Delete NonUpload Details')" />
                                    </td>
                                </tr>
                            </table>
