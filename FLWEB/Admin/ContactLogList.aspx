<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ContactLogList.aspx.cs" Inherits="Admin_ContactLogList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">ContactLog Categories</h2>
        </header>
        <div class="panel-body">
            ...
            <div class="form-group">
               ...
               &nbsp;
                ...
                <asp:GridView ID="gvConLogList" runat="server" AllowPaging="true" EmptyDataText="No Data Found" PageSize="10"
                    AutoGenerateColumns="False" CssClass="table table-bordered table-striped mb-none dataTable no-footer"
                    Width="100%" OnRowCommand="gvConLogList_RowCommand" OnPageIndexChanging="gvConLogList_PageIndexChanging" OnSorting="gvConLogList_Sorting">
                                ...
                                <table>
                                    ...
                                    <td>
                                        <asp:ImageButton ID="imgEdit" ToolTip="Edit" runat="server" ImageUrl="../images/icon-edit.png" Height="20" Width="20"
                                            CommandName="Edit Log" CommandArgument='<%#Eval("LogId") %>' />
                                        <asp:ImageButton ID="imgDelete" ToolTip="Delete" runat="server" ImageUrl="../images/icon-delete.png" Height="20" Width="20"
                                            CommandName="Delete Log" CommandArgument='<%#Eval("LogId") %>' OnClientClick="javascript:return confirm('Are You Sure To Delete ContactLog Details')" />
