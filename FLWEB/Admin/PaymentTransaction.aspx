<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="PaymentTransaction.aspx.cs" Inherits="Admin_PaymentTransaction" %>
                    ...
                    <div class="form-group">
                        <div style="height: 290px; overflow: auto">
                            ...
                            <asp:GridView ID="gvData" runat="server" AllowPaging="true" EmptyDataText="No Records Found" ShowHeaderWhenEmpty="true"
                                CssClass="table table-bordered table-striped mb-none dataTable no-footer" 
                                DataKeyNames="TicketId, invid"
                                ...
                                <Columns>
                                  ...
                                  <%--  <asp:BoundField DataField="invid" HeaderText="invid" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol">
                                    ...
                                    <asp:BoundField DataField="SupplPaiedAmount" HeaderText="Invoice Paied Amount">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    ...
                                    <asp:TemplateField HeaderText="ThisEntry" HeaderStyle-CssClass="panel-heading" ItemStyle-CssClass="gradeC">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtThisEntry" runat="server" CssClass="form-control" OnTextChanged="txtThisEntry_TextChanged" AutoPostBack="true" ValidationGroup="gvvalida"></asp:TextBox>
