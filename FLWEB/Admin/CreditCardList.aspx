<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="CreditCardList.aspx.cs" Inherits="Admin_CreditCardList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Card Types</h2>
        </header>
        <div class="panel-body">
            ...
            <div class="form-group">
               ...
               &nbsp;
                ...
                <asp:GridView ID="gvCreditCardList" runat="server" AllowPaging="true" EmptyDataText="No Data Found" PageSize="10"
                    AutoGenerateColumns="False" CssClass="table table-bordered table-striped mb-none dataTable no-footer"
                    Width="100%" OnRowCommand="gvCreditCardList_RowCommand" OnPageIndexChanging="gvCreditCardList_PageIndexChanging" OnSorting="gvCreditCardList_Sorting">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Ctl Seq">
                            <ItemTemplate>
                                <%#Eval("NumberPrefix")%>
                            </ItemTemplate>
                        </asp:TemplateField>
                                ...
                                <table>
                                    ...
                                    <td>
                                        <asp:ImageButton ID="imgEdit" ToolTip="Edit" runat="server" ImageUrl="../images/icon-edit.png" Height="20" Width="20"
                                            CommandName="Edit Credit" CommandArgument='<%#Eval("CreditCardId") %>' />
                                        <asp:ImageButton ID="imgDelete" ToolTip="Delete" runat="server" ImageUrl="../images/icon-delete.png" Height="20" Width="20"
                                            CommandName="Delete Credit" CommandArgument='<%#Eval("CreditCardId") %>' OnClientClick="javascript:return confirm('Are You Sure To Delete CreditCard Details')" />
